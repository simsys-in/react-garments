        ...
        <Header className="site-layout-background" style={{ color: 'white', backgroundColor: '#fff', padding: '0px', marginLeft : this.props.store.login.sider_collapsed ? '80px' : '200px' }} >
          <div className="row flex-nowrap">
            <div className="col-md-6">
              <h3 className="primary-text" style={{ marginTop: '10px', whiteSpace : 'nowrap', overflow : 'hidden' }}> <Button type="link" size="large" onClick={() => window.history.back()} icon={<ArrowLeftOutlined />} ></Button> Garments ERP</h3>
            </div>
