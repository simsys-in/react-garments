...
class Datebox extends PureComponent {
    ...
    render(){
        ...
        return(
            ...
            <div className={ this.props.className ? this.props.className : "col-md-6" } style={{ padding : this.props.withoutMargin ? '0' : 'auto', bottom : this.props.withoutMargin ? '0' : 'auto' ,top : this.props.withoutMargin ? '0' : 'auto', right : this.props.withoutMargin ? '0' : 'auto', left : this.props.withoutMargin ? '0' : 'auto' }}>
                <Input.Group compact >
                    
                    { showLabel ? 
                            <Form.Item validateStatus={ this.props.value ? "success" : "error" } help={ this.props.value || this.props.withoutMargin ? "" : "  Please  Select " } >
                        ...
                        <Form.Item
                            ...
                            help={ this.props.value || this.props.withoutMargin ? "" :  this.props.label }
                            rules={[
                            {
