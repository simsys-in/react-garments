                                        ...
                                        <div className="col-md-12" style={{ padding : 0,border : '1px solid gray' }}>
                                            ...
                                            <table width={"100%"} style={{border:"lightgray", margin : 0, padding : 0}}>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style={{fontWeight:"bold"}}> { getDifferentBetweenTwoDate( orderstatus_details.due_date,  new Date(), 'days')} Days</td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <table  width="100%"  >
                                                    ...
                                                    { orderstatus_details.cuttingprogram.map((item, index) => 
                                                            <tr key={index}>
                                                                ...
                                                                <td style={{ paddingTop: item.employee === "" ? '27px' : 'auto', paddingLeft : '5px' , borderLeft  : '1px solid grey',  paddingRight:'5px'}}>{ item.employee }</td>

                                                                <td style={{ paddingTop: item.employee === "" ? '27px' : 'auto', paddingLeft : '5px' , borderLeft  : '1px solid grey',  paddingRight:'5px'}}>{ item.color }</td>
