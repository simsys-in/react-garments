                                ...
                                <div className="col-md-8" style={{ padding : 0,border:'1px solid grey', borderLeft:'0',borderBottom:'0',borderTop:'0' }}>
                                    ...
                                    <table width={"100%"} style={{border:"1px solid gray", margin : 0, padding : 0,borderRight:'0'}} >
                                            ...
                                            <tr>
                                                ...
                                                <th style={{paddingLeft : '5px'}}> Remaining </th>
                                                <td style={{fontWeight:"bold"}}> { getDifferentBetweenTwoDate( shortage_details.due_date,  new Date(), 'days')} </td>
                                    ...
                                    <table  width="100%"  >
                                        ...
                                        { shortage_details.processdetails.map((item, index) => 
                                                <tr key={index}>
                                                    ...
                                                    <td style={{ paddingTop: item.inventory_qty_total === "" ? '27px' : 'auto', paddingLeft : '5px' , borderLeft  : '1px solid grey', textAlign : 'right', paddingRight:'5px'}}>{ item.outward_qty_total }</td>
