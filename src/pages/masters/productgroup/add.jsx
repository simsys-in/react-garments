...
class AddProductGroup extends PureComponent{
    ...
    getProductGroup = () => {
        ...
        if(this.id)
        {
            getRequest("masters/product_group?id=" + this.id).then(data => {
    ...
    componentWillMount = () => {
        seo({
            ...
            metaDescription: 'Add Product Group'
          });
          ...
          if(this.id)
          {
            seo({
                ...
                metaDescription: 'Edit Product Group'
              });
    ...
    onFinish = values => {
        this.setState({
            ...
            putRequest('masters/product_group?id=' + this.id, this.state.formData).then(data => {
            ...
            <Fragment>
                <div className="row">
                    <div className="col-md-12" align="right">
                        <Button type="default" htmlType="button" onClick={ () => { this.props.history.push('/masters/list_product_group') } }>
                            { this.id ? "Back" : 'List'}
                        </Button>
                    </div>
                </div>
                ...
                <Form
                    ...
                    <div className="row">
                        <Textbox label="Product Group" autoFocus modelName="product_group" className="col-md-4"></Textbox>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(AddProductGroup));