...
class AddDepartment extends PureComponent{
    ...
    getDepartment = () => {
        ...
        if(this.id)
        {
            getRequest("masters/department?id=" + this.id).then(data => {
    ...
    componentWillMount = () => {
        seo({
            ...
            metaDescription: 'Add Department'
          });
          ...
          if(this.id)
          {
            seo({
                ...
                metaDescription: 'Edit Department'
              });
    ...
    onFinish = values => {
        this.setState({
            ...
            putRequest('masters/department?id=' + this.id, this.state.formData).then(data => {
            ...
            <Fragment>
                <div className="row">
                    <div className="col-md-12" align="right">
                        <Button type="default" htmlType="button" onClick={ () => { this.props.history.push('/masters/list_department') } }>
                            { this.id ? "Back" : 'List'}
                        </Button>
                    </div>
                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(AddDepartment));