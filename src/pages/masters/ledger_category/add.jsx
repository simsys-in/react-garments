...
class AddLedger_Category extends PureComponent{
    ...
    componentWillMount = () => {
        seo({
            ...
            metaDescription: 'Add Ledger Category'
          });

          if(this.id)
          {
            seo({
                title: 'Edit Ledger Category',
                metaDescription: 'Edit Ledger Category'
              });
    ...
    onFinish = values => {
        this.setState({
            ...
            putRequest('masters/ledger_category?id=' + this.id, values).then(data => {
            ...
            <Fragment>
                <div className="row">
                    <div className="col-md-12" align="right">
                        <Button type="default" htmlType="button" onClick={ () => { this.props.history.push('/masters/list_ledger_category') } }>
                            { this.id ? "Back" : 'List'}
                        </Button>
                    </div>
                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(AddLedger_Category));