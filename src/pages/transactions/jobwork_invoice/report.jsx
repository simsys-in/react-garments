                ...
                <div className="row print-area" id="printableArea">
                    <div className="col-md-12">
                        ...
                        <div className="row flex-nowrap" >
                            <div className="col-md-8" style={{ border : '1px solid black', padding : 0, paddingLeft : 5 }}>
                            ...
                            <div className="col-md-4" style={{ padding : 0,border : '1px solid black' }}>

                                <table width={"100%"} style={{border:"lightgray", margin : 0, padding : 0}} border="1">
                                        <tr> 
                                            <td colSpan={4} style={{ backgroundColor : 'lightgray', textAlign: 'center', border : '1px solid black' }}> <h5> Jobwork Invoice </h5> </td>
                                        </tr>
                                        <tr>
                                            <th> DC No <br />
                                ...
                                <table  width="100%" >
                                    <thead>
                                        <tr  style={{ backgroundColor : 'lightgray' }}>
                                            ...
                                            <th style={{fontWeight:"bold", border : '1px solid gray', paddingLeft : '5px'}}>PRODUCT</th>
                                    ...
                                    {/* <td style={{border : '1px solid gray', paddingLeft : '5px'}}>{ item.size_id }</td> */}
                                               
                                                <td style={{border : '1px solid gray', paddingLeft : '5px'}}>{ item.product }</td>
                                                <td style={{border : '1px solid gray', paddingLeft : '5px'}}>{ item.size }</td>
                        ...
                        <div className="row">
                            <div className="col-md-6" style={{ border : '1px solid black', padding : 0, paddingLeft : 5 }}>
                                ...
                                <p style={{ whiteSpace : 'pre-line' }}> Payment should be made by DD/pay order/Cheque or  RTGS in favour of <b style={{fontWeight:"bold"}}>{ report_details.company_details.company }</b> 
