...
//                                             <th> Remaining </th>
//                                             <td style={{fontWeight:"bold"}}> { getDifferentBetweenTwoDate( report_details.due_date,  new Date(), 'days')} </td>
//                                         </tr>
//                                         <tr>
...
//                                             <td> </td>
//                                             <td></td>
//                                             <td style={{fontWeight:"bold", border : '1px solid gray', paddingLeft : '5px', textAlign:'right', paddingRight:'5px'}}>{report_details.shortage !=="" && Number(report_details.shortage).toFixed(2)}</td> */}
