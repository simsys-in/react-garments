                        ...
                        <div className="row flex-nowrap" >
                            ...
                            <div className="col-md-6" style={{ padding : 0,border : '1px solid gray', borderBottom:'0' }}>
                                ...
                                <table width={"100%"} style={{border:"light gray", margin : 0, padding : 0}} >
                                        <tr> 
                                            <td colSpan={4} style={{ backgroundColor : 'lightgray', textAlign: 'center', border : '1px solid grey' }}> <h5>YARN PURCHASE ORDER </h5> </td>
                                        </tr>
                                        <tr>
                                ...
                                <table  width="100%" style={{border:"lightgray"}}>
                                    ...
                                    {/* <td style={{border : '1px lightgray', paddingLeft : '5px'}}>{ item.size_id }</td> */}
                                        ...
                                        <tr>
                                            ...
                                            <td style={{fontWeight:"bold" , border:'1px solid gray', textAlign:'right', paddingRight:'5px'}}>{this.state.inventory_qty_total !== "" && Number(this.state.inventory_qty_total)}</td>
