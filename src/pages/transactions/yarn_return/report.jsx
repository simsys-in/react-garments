...
class Report extends PureComponent {
    ...
    componentDidMount = () => {
        getRequest('garments/getYarnReturnReport?id=' + this.props.itemId).then(data => {
            if(data.status === "info")
            {
                // data.data.inventory
                                ...
                                <table  width="100%"  >
                                    <thead>
                                        <tr  style={{ backgroundColor : 'lightgray' }}>
                                            ...
                                            <th style={{fontWeight:"bold",textAlign:"center", paddingLeft : '5px' , border: '1px solid gray'}} >FABRIC</th>
                                            <th style={{fontWeight:"bold",textAlign:"center", paddingLeft : '5px' , border: '1px solid gray'}} >GSM</th>
                                            <th style={{fontWeight:"bold",textAlign:"center", paddingLeft : '5px' , border: '1px solid gray'}} >Counts</th>
                                            <th style={{fontWeight:"bold",textAlign:"center", paddingLeft : '5px' , border: '1px solid gray'}} >Qty Per</th>
                                            <th style={{fontWeight:"bold",textAlign:"center", paddingLeft : '5px' , border: '1px solid gray'}} >Qty Bag</th>
                                            <th style={{fontWeight:"bold",textAlign:"center", paddingLeft : '5px' , border: '1px solid gray'}} >Qty Kg </th>
