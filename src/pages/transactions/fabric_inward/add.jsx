                             ...
                             <thead >
                                ...
                                <tbody>  <Form.List name="fabric_inward_inventory">
                                    { (fields, { add, remove } )=> (
                                        ...
                                        <td> <Numberbox noPlaceholder withoutMargin required="false" className="col-md-12" showLabel={false} field={field} fieldKey={[ field.fieldKey, 'roll' ]}  modelName={[field.name, 'roll']} value={[field.name, 'roll']}

                                        //  max={this.state.formData.fabric_inward_inventory[index]['max_roll']}
                                         
                                         label="Roll" 
                                         
                                         onChange={(ev) => this.setTOTAL(ev,field.fieldKey)}></Numberbox></td>

                                        <td><Numberbox noPlaceholder withoutMargin required="false" className="col-md-12"  showLabel={false} field={field} fieldKey={[ field.fieldKey, 'weight' ]}  modelName={[field.name, 'weight']} value={[field.name, 'weight']} label="Weight"

                                        //  max={this.state.formData.fabric_inward_inventory[index]['max_weight']}
