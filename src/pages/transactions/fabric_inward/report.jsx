                ...
                <div className="row print-area" id="printableArea">
                    <div className="col-md-12">
                        ...
                        <div className="row flex-nowrap" >
                            <div className="col-md-6" style={{ border : '1px solid grey', padding : 0, paddingLeft : 5, borderRight:'0', borderBottom:'0'}}>
                            ...
                            <div className="col-md-6" style={{ padding : 0,border : '1px solid grey', borderBottom:'0' }}>
                                ...
                                <table width={"100%"} style={{border:"lightgray", margin : 0, padding : 0}}>
                                        <tr> 
                                            <td colSpan={4} style={{ backgroundColor : 'lightgray', textAlign: 'center', border : '1px solid grey' }}> <h5> FABRIC RECEIPT NOTE </h5> </td>
                                        </tr>
                                        <tr>
                                            <th> DC No </th>
                        ...
                        <div className="row flex-nowrap">
                            <div className="col-md-6" style={{ border : '1px solid grey', padding : 0, paddingLeft : 5, borderRight:'0', borderTop:'0' }}>
